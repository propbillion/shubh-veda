...
(function () {
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      ...
      const message =
        'Hi%2C+I+want+Priority+Allocation+Access+for+SHUBH+VEDA+and+the+launch-phase+pricing.%0A%0A' +
  ...
  if (heroForm) {
    heroForm.addEventListener('submit', (e) => {
      ...
      const message =
        'Hi%2C+I+want+the+SHUBH+VEDA+launch+price+and+Priority+Allocation+Access.%0A%0A' +
        'Name%3A+' + encodeURIComponent(name) + '%0A' +
        'Mobile%3A+%2B91+' + encodeURIComponent(mob);
